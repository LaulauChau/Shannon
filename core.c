...
liaisons_t * bfs(liaisons_t ls, point_t p1, point_t p2)
{
	...
	tab_pere_t * tp; // table des peres (dans un bfs la table des peres stocke le pere le plus proche du point de depart)
